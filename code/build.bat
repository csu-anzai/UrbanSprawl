...
set commonFlagsLinker= -incremental:no -opt:ref user32.lib gdi32.lib winmm.lib shell32.lib ole32.lib ws2_32.lib
...
del lock.tmp
cl %commonFlagsCompiler% ..\code\w32_urban.cpp /link %commonFlagsLinker%
popd
...
cl %commonFlagsCompiler% ..\..\code\map_editor\win32_urban_mapedit.cpp /link %commonFlagsLinker% comdlg32.lib
popd